...
for i in bin/ujust share/ublue-os/just/{00-entry.just,apps.just,default.just,system.just,update.just,} \
    share/bash-completion/completions/ujust share/zsh/site-functions/_ujust ; do
   stat /usr/"$i"
done
