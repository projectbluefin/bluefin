...
# First-party countme reporting to countme.projectbluefin.io:
# the timer, service and client ship in the projectbluefin/common image and
# run periodically, with a client-side seven-day throttle, alongside the Fedora
# upstream countme. Users opt out with /etc/projectbluefin/countme/disabled.
# See: https://github.com/projectbluefin/bluefin/issues/1216
